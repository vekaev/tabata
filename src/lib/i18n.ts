...
const es: Record<Keys, string> = {
  ...
  done: 'Listo', round: 'Ronda', set: 'Serie', next: 'Siguiente', roundNames: 'Nombres de rondas',
...
const fr: Record<Keys, string> = {
  ...
  done: 'Terminé', round: 'Round', set: 'Série', next: 'Suivant', roundNames: 'Noms des rounds',
...
const de: Record<Keys, string> = {
  ...
  done: 'Fertig', round: 'Runde', set: 'Satz', next: 'Nächste', roundNames: 'Rundennamen',
...
const pt: Record<Keys, string> = {
  ...
  done: 'Concluído', round: 'Round', set: 'Série', next: 'Próximo', roundNames: 'Nomes dos rounds',
...
const uk: Record<Keys, string> = {
  ...
  done: 'Готово', round: 'Раунд', set: 'Сет', next: 'Далі', roundNames: 'Назви раундів',
...
const ru: Record<Keys, string> = {
  ...
  done: 'Готово', round: 'Раунд', set: 'Сет', next: 'Далее', roundNames: 'Названия раундов',
