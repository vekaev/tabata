...
const en = {
  ...
  reportProblem: 'Report a problem', getApp: 'Get the desktop app',
...
const es: Record<Keys, string> = {
  ...
  custom: 'Personalizado', support: 'Soporte', reportProblem: 'Reportar un problema', getApp: 'Obtener la app de escritorio',
...
const fr: Record<Keys, string> = {
  ...
  custom: 'Personnalisé', support: 'Support', reportProblem: 'Signaler un problème', getApp: 'Obtenir l’app de bureau',
...
const de: Record<Keys, string> = {
  ...
  reportProblem: 'Problem melden', getApp: 'Desktop-App holen', fullscreen: 'Vollbild', mute: 'Stumm', unmute: 'Ton an',
...
const pt: Record<Keys, string> = {
  ...
  custom: 'Personalizado', support: 'Suporte', reportProblem: 'Relatar um problema', getApp: 'Obter o app para desktop',
...
const zh: Record<Keys, string> = {
  ...
  dark: '深色', custom: '自定义', support: '支持', reportProblem: '报告问题', getApp: '获取桌面应用', fullscreen: '全屏',
...
const hi: Record<Keys, string> = {
  ...
  custom: 'कस्टम', support: 'सहायता', reportProblem: 'समस्या बताएं', getApp: 'डेस्कटॉप ऐप पाएं', fullscreen: 'पूर्ण स्क्रीन',
...
const ar: Record<Keys, string> = {
  ...
  dark: 'داكن', custom: 'مخصص', support: 'الدعم', reportProblem: 'الإبلاغ عن مشكلة', getApp: 'تنزيل تطبيق سطح المكتب',
...
const ja: Record<Keys, string> = {
  ...
  dark: 'ダーク', custom: 'カスタム', support: 'サポート', reportProblem: '問題を報告', getApp: 'デスクトップアプリを入手', fullscreen: '全画面',
...
const ko: Record<Keys, string> = {
  ...
  dark: '다크', custom: '사용자 지정', support: '지원', reportProblem: '문제 신고', getApp: '데스크톱 앱 받기', fullscreen: '전체 화면',
...
const it: Record<Keys, string> = {
  ...
  custom: 'Personalizzato', support: 'Supporto', reportProblem: 'Segnala un problema', getApp: 'Scarica l’app desktop',
...
const tr: Record<Keys, string> = {
  ...
  dark: 'Koyu', custom: 'Özel', support: 'Destek', reportProblem: 'Sorun bildir', getApp: 'Masaüstü uygulamasını al', fullscreen: 'Tam ekran',
...
const id: Record<Keys, string> = {
  ...
  support: 'Dukungan', reportProblem: 'Laporkan masalah', getApp: 'Dapatkan aplikasi desktop', fullscreen: 'Layar penuh', mute: 'Bisukan',
...
const vi: Record<Keys, string> = {
  ...
  reportProblem: 'Báo lỗi', getApp: 'Tải ứng dụng máy tính', fullscreen: 'Toàn màn hình', mute: 'Tắt tiếng', unmute: 'Bật tiếng',
...
const pl: Record<Keys, string> = {
  ...
  support: 'Wsparcie', reportProblem: 'Zgłoś problem', getApp: 'Pobierz aplikację na komputer', fullscreen: 'Pełny ekran', mute: 'Wycisz',
...
const nl: Record<Keys, string> = {
  ...
  light: 'Licht', dark: 'Donker', custom: 'Aangepast', support: 'Ondersteuning', reportProblem: 'Probleem melden', getApp: 'Desktop-app downloaden',
...
const th: Record<Keys, string> = {
  ...
  reportProblem: 'รายงานปัญหา', getApp: 'ดาวน์โหลดแอปเดสก์ท็อป', fullscreen: 'เต็มจอ', mute: 'ปิดเสียง', unmute: 'เปิดเสียง', sound: 'เสียง',
...
const sv: Record<Keys, string> = {
  ...
  reportProblem: 'Rapportera ett problem', getApp: 'Hämta skrivbordsappen', fullscreen: 'Helskärm', mute: 'Tysta', unmute: 'Slå på ljud',
...
const uk: Record<Keys, string> = {
  ...
  dark: 'Темна', custom: 'Свій', support: 'Підтримка', reportProblem: 'Повідомити про проблему', getApp: 'Завантажити застосунок',
...
const ru: Record<Keys, string> = {
  ...
  dark: 'Тёмная', custom: 'Свой', support: 'Поддержка', reportProblem: 'Сообщить о проблеме', getApp: 'Скачать приложение',
...
const fa: Record<Keys, string> = {
  ...
  custom: 'سفارشی', support: 'پشتیبانی', reportProblem: 'گزارش مشکل', getApp: 'دریافت برنامه دسکتاپ', fullscreen: 'تمام‌صفحه', mute: 'بی‌صدا',
...
const he: Record<Keys, string> = {
  ...
  custom: 'מותאם', support: 'תמיכה', reportProblem: 'דווח על בעיה', getApp: 'הורד את אפליקציית השולחן', fullscreen: 'מסך מלא', mute: 'השתק',
...
const cs: Record<Keys, string> = {
  ...
  custom: 'Vlastní', support: 'Podpora', reportProblem: 'Nahlásit problém', getApp: 'Získat desktopovou aplikaci', fullscreen: 'Celá obrazovka',
...
const el: Record<Keys, string> = {
  ...
  support: 'Υποστήριξη', reportProblem: 'Αναφορά προβλήματος', getApp: 'Λήψη εφαρμογής υπολογιστή', fullscreen: 'Πλήρης οθόνη', mute: 'Σίγαση',
...
const ro: Record<Keys, string> = {
  ...
  reportProblem: 'Raportează o problemă', getApp: 'Descarcă aplicația desktop', fullscreen: 'Ecran complet', mute: 'Mut', unmute: 'Activează sunetul',
