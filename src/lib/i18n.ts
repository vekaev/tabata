...
const es: Record<Keys, string> = {
  ...
  done: 'Listo', round: 'Ronda', set: 'Serie', next: 'Siguiente', roundNames: 'Etiquetas de rondas', advanced: 'Avanzado',
...
const fr: Record<Keys, string> = {
  ...
  done: 'Terminé', round: 'Round', set: 'Série', next: 'Suivant', roundNames: 'Libellés des rounds', advanced: 'Avancé',
...
const de: Record<Keys, string> = {
  ...
  done: 'Fertig', round: 'Runde', set: 'Satz', next: 'Nächste', roundNames: 'Runden-Labels', advanced: 'Erweitert',
...
const pt: Record<Keys, string> = {
  ...
  done: 'Concluído', round: 'Round', set: 'Série', next: 'Próximo', roundNames: 'Rótulos dos rounds', advanced: 'Avançado',
...
const uk: Record<Keys, string> = {
  ...
  done: 'Готово', round: 'Раунд', set: 'Сет', next: 'Далі', roundNames: 'Підписи раундів', advanced: 'Розширені',
...
const ru: Record<Keys, string> = {
  ...
  done: 'Готово', round: 'Раунд', set: 'Сет', next: 'Далее', roundNames: 'Подписи раундов', advanced: 'Дополнительно',
