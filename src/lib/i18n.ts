...
const es: Record<Keys, string> = {
  ...
  done: 'Listo', round: 'Ronda', set: 'Serie', next: 'Siguiente', roundNames: 'Etiquetas de rondas', advanced: 'Avanzado', unsaved: 'Sin guardar',
...
const fr: Record<Keys, string> = {
  ...
  done: 'Terminé', round: 'Round', set: 'Série', next: 'Suivant', roundNames: 'Libellés des rounds', advanced: 'Avancé', unsaved: 'Non enregistré',
...
const de: Record<Keys, string> = {
  ...
  done: 'Fertig', round: 'Runde', set: 'Satz', next: 'Nächste', roundNames: 'Runden-Labels', advanced: 'Erweitert', unsaved: 'Nicht gespeichert',
...
const pt: Record<Keys, string> = {
  ...
  done: 'Concluído', round: 'Round', set: 'Série', next: 'Próximo', roundNames: 'Rótulos dos rounds', advanced: 'Avançado', unsaved: 'Não salvo',
...
const uk: Record<Keys, string> = {
  ...
  done: 'Готово', round: 'Раунд', set: 'Сет', next: 'Далі', roundNames: 'Підписи раундів', advanced: 'Розширені', unsaved: 'Не збережено',
...
const ru: Record<Keys, string> = {
  ...
  done: 'Готово', round: 'Раунд', set: 'Сет', next: 'Далее', roundNames: 'Подписи раундов', advanced: 'Дополнительно', unsaved: 'Не сохранено',
